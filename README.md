...
[![Stars](https://img.shields.io/github/stars/WeAreDevs-Execute-Update-v3.8?style=flat-square)](https://github.com)
...
git clone https://github.com/WeAreDevs-Execute-Update-v3.8.git
cd WeAreDevs-Execute-Update-v3.8
